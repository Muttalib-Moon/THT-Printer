...
{
//å…ˆpoståˆ°ä»»åŠ¡ï¼Œç”±ä»»åŠ¡è°ƒç”¨cdc_read_data()è¯»å–å†æ‰§è¡ŒåŽç»­å·¥ä½?
...
void usb_start(const usb_dev usbfd)
{
    ...
    int msg[16];
	int cc;
    printf("usb_startting........\r");
#if 1
	os_time_dly(200); // 500 // 200 // @20240325 SangStoneAngleAlke  ²âÊÔÏÂÀ´Ã»ÓÐÐ§¹û
#else
	for(cc = 200; cc; cc--)
	{
...
#if TCFG_USB_SLAVE_MSD_ENABLE
    //æ²¡æœ‰å¤ç”¨æ—¶å?™åˆ¤æ–? sdå¼?å…?
    //å¤ç”¨æ—¶å?™åˆ¤æ–­æ˜¯å¦å‚ä¸Žå¤ç”?
