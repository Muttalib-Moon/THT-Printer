...
#endif
#endif
#define USER_SUPPORT_PROFILE_A2DP   0//1   // @Sang @20240318 Bt auto link mobile as audio device
#define USER_SUPPORT_PROFILE_AVCTP  0//1   // @Sang @20240318 Bt auto link mobile as audio device
#define USER_SUPPORT_PROFILE_HID    0
#define USER_SUPPORT_PROFILE_PNP    0
#define USER_SUPPORT_PROFILE_PBAP   0//1   // @Sang @20240318 Bt auto link mobile as audio device
