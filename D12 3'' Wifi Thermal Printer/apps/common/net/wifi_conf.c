...
const char WIFI_CHANNEL_QUALITY_INDICATION_BAD = 5; //antenna quality threshold value
...
const u8 ntp_get_time_init = 0;	//Online time function 0:close, 1:open

const u8 CONFIG_SDIO_SLAVE_MODE = 0; //SDIO slave 0:close, 1:open
