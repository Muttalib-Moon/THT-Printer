...
#define SBC_FILTER_TIME_MS			2000
#define SBC_ZERO_TIME_MS			500
#define NO_SBC_TIME_MS				100
...
unsigned char BLE_MAC[6],EDR_MAC[6];
...
#endif
	transport_spp_flow_cfg(); // @202402181431 Alke
	//@20240319 Sang Stone Angle Alke close
///////////////////////////////////////////////////////////////
	// @20240906 sang for ble mac
...
#endif //
	memcpy(BLE_MAC,tmp_ble_addr,6);
	memcpy(EDR_MAC,(u8 *)bt_get_mac_addr(),6);
...
#if 1 //(USER_SUPPORT_PROFILE_PBAP==1)

		printf("sang:set class of device\n");
		//__change_hci_class_type(BD_CLASS_CAR_AUDIO);
		__change_hci_class_type(0x40680); // @20230706 Alke Sang
#endif
/////////////////////////////////////////////////////////////////////////////////
}
...
{
    printf("+-+bt_hci_event_handler reason 0x%x", bt->event);
    ...
    case HCI_EVENT_USER_CONFIRMATION_REQUEST:
        ...
        ///<可�?�过按键来确认是否配�? 1：配�?   0：取�?  ///<��ͨ��������ȷ���Ƿ���� 1�����   0��ȡ��
        bt_send_pair(1); // @20240318 Sang ����ɣ��˵�����γ���
        break;
