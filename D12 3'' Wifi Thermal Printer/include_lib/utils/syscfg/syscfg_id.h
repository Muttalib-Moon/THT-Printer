 ...
 *
 * @return 1)执行正确: 返回值等于实际上所读到的数据长度(大于0); OK: NOT 0
 *         2)执行错误: 返回值小于等于0, 小于0表示相关错误码;						ERR: 0
 */
/* --------------------------------------------------------------------------*/
...
//WIFI类配置项[180 ~ 250]
#define    NETWORK_SSID_INFO_CNT       1 // Alke 20230713 WIFI个数 SSID PWD //配置VM里面保存多少个路由器信息, 如果不需要写0
