...
//static inline unsigned char get_rect_cover(const struct rect *a, const struct rect *b, struct rect *c)
{
    int right, bottom;
...
//static inline unsigned char get_rect_nocover_l(const struct rect *a, const struct rect *b, struct rect *c)
{
    int right, bottom;
...
//static inline unsigned char get_rect_nocover_r(const struct rect *a, const struct rect *b, struct rect *c)
{
    int right, bottom;
...
//static inline unsigned char get_rect_nocover_t(const struct rect *a, const struct rect *b, struct rect *c)
{
    int right, bottom;
...
//static inline unsigned char get_rect_nocover_b(const struct rect *a, const struct rect *b, struct rect *c)
{
    int right, bottom;
