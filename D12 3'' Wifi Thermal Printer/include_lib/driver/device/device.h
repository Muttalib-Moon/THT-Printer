...
struct device_operations {
    ...
    unsigned char (*online)(const struct dev_node *node);
...
unsigned char dev_online(const char *name);
/// \endcond

/**
 * @brief dev_open：用于打开一个设备
 *
 * @param name 设备名称
